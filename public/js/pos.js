$(document).ready(function() {
    ...
    $('#exchange_rate').change(function() {
        ...
        var total_payable = __read_number($('input#final_total_input'));
        shown_total = total_payable * curr_exchange_rate; // Remove var to avoid redeclaration
...
var price_total; // Declare price_total variable globally

function pos_total_row() {
    var total_quantity = 0;
    price_total = get_subtotal(); // Assign value to the global variable
...
function calculate_billing_details(price_total) {
 ...
 //i want to use here ramount live input value  in this function ..
  ...
  $('#ramount').keyup(function(){
    ramount = $(this).val();
    var bkaya=ramount-shown_total;
    var total_returned = parseFloat(bkaya) || 0;

			...
			@if(empty($receipt_details->hide_price))
				...
				@endif
					@if(isset($recamount))
    					<div class="flex-box">
    						<p class="width-50 text-right">
    							<b style="font-size:15px;">Amount Received :</b> 
    						</p>
    						<p class="width-50 text-right">
    							<b style="font-size:15px;">Rs {{$recamount}}</b>
    						</p>
    					</div>
					@endif
				<!-- Total Paid-->
				...
				@endif
					@if(isset($recamount))
    					<div class="flex-box">
    						<p class="width-50 text-right">
    							<b style="font-size:15px;">Returned :</b> 
    						</p>
    						<p class="width-50 text-right">
    							<b style="font-size:15px;">Rs {{$recamount - substr($receipt_details->total_paid, 3) }}</b>
    						</p>
    					</div>
					@endif
				<!-- Total Due-->

...
<section class="content">
    ...
    <div style="display: flex; gap: 20px; margin: 10px 0px;">
        <div>
            <a class="btn" style="  font-size:20px; background: #1572e8;border-color: #1367d1; color:white; border-radius:10px;" href="{{route('profitLossReport')}}">Products Profit / Loss Report</a>
        </div>
    </div>
